                                            ...
                                            while (1) {
                                                switch (_context3.prev = _context3.next) {
                                                    case 0:
                                                        ...
                                                        TrezorConnect.ethereumSignTx(this._accounts[0], txData.nonce, txData.gasPrice, txData.gasLimit, txData.to, txData.value, txData.data, chain_id, function (response) {
                                                            if (response.success) {
